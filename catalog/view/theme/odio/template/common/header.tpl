...
<!-- google fonts -->
<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=BenchNine:400,600,700|Noticia+Text:400,700" />
<style type="text/css">
.primary-define h1,
.primary-define h2,
.primary-define h3,
...
<?php } ?>
<!--[if lte IE 8]>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/odio-pro/stylesheet/ie.css" />
<![endif]-->
<?php if ($stores) { ?>
