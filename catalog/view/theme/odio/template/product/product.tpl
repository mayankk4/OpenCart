...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="right" style="margin-left: <?php echo $this->config->get('config_image_thumb_width') + 52 ?>px;">
      ...
      <div class="review">
        <img src="catalog/view/theme/default/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" /><a class="show-review" href="#tabs"><?php echo $reviews; ?></a>
  ...
  <div id="tab-review" class="tab-content">
    ...
    <div class="buttons">
      <div class="right"><a id="button-review" class="icon-forward-white button"><?php echo $button_continue; ?></a></div>
    </div>
  </div>
  <?php } ?>
  <?php if ($products) { ?>
  ...
  <div class="box-content">
    <div class="box-product product-grid">
      ...
      <div class="details">
		...
		<div class="wishlist"><a class="icon-wishlist-white button" onclick="addToWishList('<?php echo $product['product_id']; ?>');"><?php echo $button_wishlist; ?></a></div>
		<div class="compare"><a class="icon-compare-white button" onclick="addToCompare('<?php echo $product['product_id']; ?>');"><?php echo $button_compare; ?></a></div>
      </div>
