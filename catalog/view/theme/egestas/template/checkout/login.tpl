<div class="left">
  ...
  <div class="buttons">
  <div class="right">
  <input type="button" value="<?php echo $button_continue; ?>" id="button-account" class="icon-forward-white button" />
  </div>
  </div>
</div>
<div id="login" class="right">
  ...
  <div class="right">
  <input type="button" value="<?php echo $button_login; ?>" id="button-login" class="icon-lock-white button" />
  </div>
  </div>
</div>