<div id="cart">
  ...
  <div class="content">
    ...
    <div class="checkout"><a href="<?php echo $cart; ?>" class="icon-add-to-cart button"><?php echo $text_cart; ?></a>&nbsp;&nbsp;<a href="<?php echo $checkout; ?>" class="icon-checkout-white button"><?php echo $text_checkout; ?></a></div>
    <?php } else { ?>
